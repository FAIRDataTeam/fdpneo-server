...
:class:`ParsedUpdate` from :mod:`fdp.access.parser` plus the user's
...
from fdp.access.parser import ParsedRead, ParsedUpdate
...
def rewrite_read(
    ...
    *,
    ...
    Args:
        parsed: Output of :func:`fdp.access.parser.parse` for a read query.
