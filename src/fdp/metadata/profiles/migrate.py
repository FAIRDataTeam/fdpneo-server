...
from fdp.metadata.profiles.rd_records import record_to_graph
from fdp.metadata.profiles.rd_service import load_definition_records
...
if TYPE_CHECKING:
    ...
    from fdp.metadata.profiles.rd_records import ResourceDefinitionRecord
...
def _rd_record_iri(record: ResourceDefinitionRecord, expander: IRIExpander) -> str:
    from fdp.metadata.profiles.rd_records import rd_record_slug
