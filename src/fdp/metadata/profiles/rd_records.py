...
:class:`~fdp.metadata.profiles.registry.ResourceDefinitionCache` (which
...
The vocabulary terms live in :mod:`fdp.shared.namespaces` (fixed FDP ontology
terms, not deployment-configurable). The shape's own IRI is
:data:`RD_SHAPE_IRI`, fixed the same way as
:data:`fdp.metadata.meta.META_SHAPE_IRI`.
"""
