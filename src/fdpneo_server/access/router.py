...
:func:`fdpneo_server.access.rewriter.authorize_update` plays that role.
"""
...
from fdpneo_server.access.parser import ParsedRead, ParsedUpdate, QueryForm, parse
from fdpneo_server.access.results import select_result_media_type
...
if TYPE_CHECKING:
    ...
    from fdpneo_server.shared.visibility import StateVisibility
