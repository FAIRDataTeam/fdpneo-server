...
deferred — see :mod:`fdpneo_server.metadata.settings`).
"""
...
from fdpneo_server.shared.errors import BadRequest, Conflict, Forbidden

if TYPE_CHECKING:
    from collections.abc import Awaitable, Callable

    from fdpneo_server.config import Settings
    from fdpneo_server.metadata.profiles import ResourceDefinitionCache
    from fdpneo_server.metadata.repository import MetadataRepository
    from fdpneo_server.metadata.settings import SettingsRepository
