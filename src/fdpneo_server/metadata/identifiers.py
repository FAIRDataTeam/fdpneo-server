...
:mod:`fdpneo_server.shared.identifiers`). A client may nonetheless submit a body whose
...
:func:`fdpneo_server.metadata.patch.simulate_update`'s discipline) so the LDP layer stays
...
from fdpneo_server.shared.identifiers import is_under
from fdpneo_server.shared.namespaces import ADMS, DCT, SKOS, XSD
