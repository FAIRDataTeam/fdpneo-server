...
from fdpneo_server.metadata.search.repository import FacetBucket, SearchHit, SearchQuery

if TYPE_CHECKING:
    from fdpneo_server.config import SearchSettings
    from fdpneo_server.metadata.lifecycle import StateGate
    from fdpneo_server.metadata.search.repository import SearchIndexRepository, SearchResult
