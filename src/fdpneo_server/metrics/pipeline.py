...
Subscribes to :class:`fdpneo_server.metrics.events.RequestObserved`, runs it
through :func:`fdpneo_server.metrics.anonymize.anonymize`, and persists the
...
records handler errors too (see :mod:`fdpneo_server.shared.events`), but losing
...
from fdpneo_server.metrics.events import RequestObserved
